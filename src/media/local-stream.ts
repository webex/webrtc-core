...
abstract class _LocalStream extends Stream {
  ...
  /**
   * Check whether or not this stream has been muted by the user. This is equivalent to getting
   * whether or not the MediaStreamTrack is in the "enabled" state.
   *
  ...
  /**
   * Check whether or not this stream has been muted by the user. This is equivalent to getting
   * whether or not the MediaStreamTrack is in the "muted" state.
   *
