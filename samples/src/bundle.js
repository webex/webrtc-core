    ...
    class LocalTrack extends EventEmitter {
        ...
        constructor(stream) {
            ...
            this.underlyingTrack.onended = () => {
                this.emit(exports.LocalTrackEvents.Ended, { trackState: this.trackState });
            };
        }
        /**
        ...
        setMuted(muted) {
            ...
            if (this.underlyingTrack.enabled === muted) {
                ...
                this.emit(exports.LocalTrackEvents.Muted, { trackState: this.trackState });
    ...
    function createCameraTrack(constraints) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new WcmeError(exports.ErrorTypes.CREATE_CAMERA_TRACK_FAILED, `Failed to create camera track ${error}`);
            }
    ...
    function createMicrophoneTrack(constraints) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new WcmeError(exports.ErrorTypes.CREATE_MICROPHONE_TRACK_FAILED, `Failed to create microphone track ${error}`);
            }
    ...
    function getDevices(deviceKind) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new WcmeError(exports.ErrorTypes.DEVICE_PERMISSION_DENIED, 'Failed to ensure device permissions');
            }
